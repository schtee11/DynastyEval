...
const collegeStats2025 = {
  ...
  "sone ntoh": {
    position: "RB",
    team: "Monmouth",
    rushing: { YDS: 1100, TD: 12, CAR: 204 },
  ...
  "hollywood smothers": {
    ...
    rushing: { YDS: 980, TD: 9, CAR: 188 },
    receiving: { REC: 22, YDS: 175, TD: 1, TARGETS: 28 },
    ppa: { averagePPA: { all: 0.11 } },
    pffGrade: 76.0,
    pffRunGrade: 78.0,
    elusiveRating: 90.0,
    yardsAfterContact: 580,
    avoidedTackles: 42,
    longest: 58,
    gamesPlayed: 12,
  },
  "dylan devezin": {
    position: "RB",
    team: "Oregon State",
    rushing: { YDS: 870, TD: 8, CAR: 174 },
    receiving: { REC: 18, YDS: 140, TD: 1, TARGETS: 22 },
    ppa: { averagePPA: { all: 0.11 } },
    pffGrade: 74.0,
    pffRunGrade: 76.0,
    elusiveRating: 72.0,
  ...
  "kejon owens": {
    position: "RB",
    team: "UTEP",
    rushing: { YDS: 820, TD: 7, CAR: 171 },
    receiving: { REC: 25, YDS: 190, TD: 2, TARGETS: 30 },
    ppa: { averagePPA: { all: 0.10 } },
    pffGrade: 72.0,
    pffRunGrade: 74.0,
    elusiveRating: 70.0,
  ...
  "desmond reid": {
    position: "RB",
    team: "Pittsburgh",
    rushing: { YDS: 1150, TD: 10, CAR: 192 },
    receiving: { REC: 55, YDS: 480, TD: 4, TARGETS: 68 },
    ppa: { averagePPA: { all: 0.20 } },
    pffGrade: 88.0,
    pffRunGrade: 86.0,
    elusiveRating: 110.0,
    yardsAfterContact: 690,
    avoidedTackles: 48,
    longest: 72,
    gamesPlayed: 12,
  },
  "anthony hankerson": {
    position: "RB",
    team: "UCF",
    rushing: { YDS: 920, TD: 10, CAR: 180 },
    receiving: { REC: 16, YDS: 130, TD: 1, TARGETS: 20 },
    ppa: { averagePPA: { all: 0.12 } },
    pffGrade: 76.0,
    pffRunGrade: 78.0,
    elusiveRating: 80.0,
  ...
  "demond claiborne": {
    position: "RB",
    team: "Wake Forest",
    rushing: { YDS: 1050, TD: 12, CAR: 181 },
    receiving: { REC: 24, YDS: 200, TD: 2, TARGETS: 30 },
    ppa: { averagePPA: { all: 0.16 } },
    pffGrade: 84.0,
    pffRunGrade: 86.0,
    elusiveRating: 98.0,
  ...
  "lincoln pare": {
    ...
    rushing: { YDS: 900, TD: 8, CAR: 180 },
    receiving: { REC: 20, YDS: 165, TD: 1, TARGETS: 24 },
    ppa: { averagePPA: { all: 0.11 } },
    pffGrade: 74.0,
    pffRunGrade: 76.0,
    elusiveRating: 75.0,
    yardsAfterContact: 520,
    avoidedTackles: 30,
    longest: 52,
    gamesPlayed: 12,
  },
  "jam miller": {
    position: "RB",
    team: "Alabama",
    rushing: { YDS: 1080, TD: 13, CAR: 200 },
    receiving: { REC: 14, YDS: 95, TD: 0, TARGETS: 18 },
    ppa: { averagePPA: { all: 0.15 } },
    pffGrade: 84.0,
    pffRunGrade: 86.0,
    elusiveRating: 92.0,
