...
const MyBoard = () => {
  ...
  const exportBoard = () => {
    const lines = currentBoard.map((p, i) =>
      `${i + 1}. ${p.name} (${p.position}) - ${p.college} | R${p.draftRound} Pick #${p.draftPick} ${p.draftTeam}${hasInjuryRisk(p) ? ' ⚠️ INJURY' : ''}`
    );
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{
                            ...
                            {player.college} · {capital.emoji} R{player.draftRound} #{player.draftPick} {player.draftTeam}
                          </div>
                        </div>
